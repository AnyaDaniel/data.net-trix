...
const Services = () => {
  return (
    <div>
        <div className="pt-20 px-4 md:px-32">
            <h1 className="text-[60px] pb-2 flex items-end">Services We Render<span className="text-[#F8C301] text-[60px] font-[700]">.</span></h1>
            <div className="line"></div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-20 px-4 md:px-32">
