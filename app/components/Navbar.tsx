...
const Navbar = () => {
  ...
  return (
    <div>
      <div className='w-full bg-[#27592D] fixed z-50'>
        <div className="flex justify-center items-center text-white py-5">
            <div className="flex justify-between items-center w-[70%]">
                ...
                <ul className="md:flex font-[700] text-[19px] gap-10 hidden">
                    ...
                    <Link href={'/services'}><li className="hover:text-[#F8C301]">Services</li></Link>
                    <Link href={'/contact'}><li className="hover:text-[#F8C301]">Contact Us</li></Link>
                </ul>
